...
export default function AppWeeklySales(props) {
  ...
  return (
    <Card sx={{ height: '100%',margin:"0px",padding:"0px",backgroundColor:"#fff7cd",color:"#7a4f01",borderRadius:"25px"}}>
        <CardHeader title={
        ...
        <RootStyle sx={{ height: '100%',margin:"0px",padding:"0px",backgroundColor:"#fff7cd",color:"#7a4f01"}}>
            ...
            <IconWrapperStyle>
                <Iconify icon="icon-park-outline:maximum" sx={{color:"#7a4f01"}} width={24} height={24} />
            </IconWrapperStyle>
            <Typography variant="h3">{fShortenNumber(MaxData)}</Typography>
