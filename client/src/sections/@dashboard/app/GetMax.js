...
export default function AppWeeklySales(props) {
  ...
  return (
    <Card sx={{ height: '100%',margin:"0px",padding:"0px",backgroundColor:"#dc00ff"}}>
        <Container>
        ...
        <RootStyle sx={{ height: '100%',margin:"0px",padding:"0px",backgroundColor:"#dc00ff"}}>
            ...
            <IconWrapperStyle>
                <Iconify icon="icon-park-outline:maximum" width={24} height={24} />
            </IconWrapperStyle>
