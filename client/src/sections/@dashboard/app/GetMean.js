  ...
  const token = localStorage.getItem("token")
    ...
    useEffect(() =>{
      if(props.data!=null)
      {
        ...
        setMeanData(_.sum(ss)/_.size(ss));
    ...
    const handelchange=(e)=>{
      ...
      setMeanData(_.sum(ss)/_.size(ss));
      //console.log(_.sum(ss)/_.size(ss))
      setFn(e.target.value)
    }
  return (
    <Card sx={{ height: '100%',margin:"0px",padding:"0px", backgroundColor:"#d0f2ff",color:"#04297a",borderRadius:"25px"}}>
         <CardHeader title={
        ...
        <RootStyle sx={{ height: '100%',margin:"0px",padding:"0px", backgroundColor:"#d0f2ff",color:"#04297a"}}>
            ...
            <IconWrapperStyle>
                <Iconify icon="carbon:chart-average" sx={{color:"#04297a"}} width={24} height={24} />
            </IconWrapperStyle>
            <Typography variant="h3">{fShortenNumber(MeanData)}</Typography>
