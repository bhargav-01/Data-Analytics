...
export default function AppWeeklySales(props) {
  ...
  return (
    <Card sx={{ height: '100%',margin:"0px",padding:"0px", backgroundColor:"#ffd600"}}>
        <Container>
        ...
        <RootStyle sx={{ height: '100%',margin:"0px",padding:"0px", backgroundColor:"#ffd600"}}>
            ...
            <IconWrapperStyle>
                <Iconify icon="carbon:chart-average" width={24} height={24} />
            </IconWrapperStyle>
