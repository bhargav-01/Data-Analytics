...
export default function AppWeeklySales(props) {
  ...
  return (
    <Card sx={{ height: '100%',margin:"0px",padding:"0px",backgroundColor:"#d1e9fc",color:"#061b64",borderRadius:"25px"}}>
        <CardHeader title={
        ...
        <RootStyle sx={{ height: '100%',margin:"0px",padding:"0px",backgroundColor:"#d1e9fc",color:"#061b64"}}>
            ...
            <IconWrapperStyle>
                <Iconify icon="carbon:chart-minimum" sx={{color:"#061b64"}} width={24} height={24} />
            </IconWrapperStyle>
